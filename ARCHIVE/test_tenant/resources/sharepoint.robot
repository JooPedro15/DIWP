*** Settings ***
Documentation        Collab main page resources
...
Verify Sensitivity Labels list
    ...
    log    Actual SL: ${holder_list}    WARN
    Log    Expected SL: ${expected_sensitivity_labels}    WARN
...
Verify Space Type list
    ...
    Log    Actual SL: ${holder_list}    WARN
    Log    Expected SL: ${expected_space_types}    WARN

...
${browser}       Chrome
${tenant_url}    https://icrc.sharepoint.com/_layouts/15/sharepoint.aspx?&login_hint=jsilva@icrc.org
${user_email}    jsilva@icrc.org
${enc_pass}      crypt:8PJbON6hXYRCltgRg3OqcbqorXrzbOfOqECEkWctH0kgjQUvZGzkn5qW450u6CHK6/bXwxLV7ArI9vhb4C0=
#Login elements

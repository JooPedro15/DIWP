*** Settings ***
Documentation    Package 2.2
#                Request a new Teams Group - multiple iterations
#                Business Validator rejections
#                Iterations defined in append package2.1_data.csv file
Library          SeleniumLibrary
Library          DataDriver    file=../Resources/package2.2_data.csv    encoding=utf_8    dialect=excel
...
Create a new request
    ...
    Wait Until Element Is Visible And Input Text    ${description_input}    Business Validator rejects
    ...
    ${l2appsadmin_validation}    Run Keyword And Return Status    Should Contain    ${space_type}     L2 Aps Admin
